...
use App\Http\Controllers\Admin\AutoEnquiryController;
...
//End of use statements
        ...
        //AutoEnquiries
        Route::resource('auto_enquiries', AutoEnquiryController::class);
        Route::post('auto_enquiries/data', [AutoEnquiryController::class, 'data'])->name('auto_enquiries.data');
        Route::post('auto_enquiries/list', [AutoEnquiryController::class, 'list'])->name('auto_enquiries.list');
