...
@section('title') Car Engine | OEM Used Car Part @endsection
@section('robots')
        ...
        <div class="container">
            <div class="banner-flex">
                ...
                <div class="banner-text">
                    <h1>Browse Our Extensive <span class="highlight">Engine Inventory</span> Online</h1>
                    <p>
                ...
                <div class="banner-form">
                    <div class="form-box">
                        ...
                        <h3 class="text-center">Let’s Find The Perfect Engine For You.</h3>
                        ...
                        <form action="/lead-enquiry" enctype="multipart/form-data" method="POST" id="leadForm" data-wow-delay="0.5s">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="Engine" readonly>
                                <input type="hidden" name="vehicle_part" value="Engine Lead Form Enquiry">
                            </div>
                ...
                <div class="row m-0 align-items-center">
                    <div class="col-lg-6 p-0">
                        <div class="quality-img">
                            <img src="/frontend/my-img/pic.png" 
                            alt="Quality" 
                    ...
                    <div class="col-lg-6 p-0">
                        <div class="quality-content">
                            <div class="section-title">
                                <h2>Driven By Passion, Powered by Performance</h2>
                            <p>At <b>OEM Used Car Parts</b>, we specialize in providing high-quality <b>Engine Components</b> that keep your vehicle running at peak performance. From cylinders to pistons, camshafts to crankshafts, every part is carefully inspected and tested to ensure reliability and durability. With years of experience and a commitment to excellence, we make engine maintenance simple, trustworthy, and hassle-free—so your car performs like new.</p>
                            </div>
                            <div class="cmn-btn">
                                <a class="banner-btn-left" href="tel:+18883707485">
                                    <i class='bx bx-phone-call' ></i>
        ...
        <div class="container">
            <div class="quality-content">
                <div class="section-title">
                    ...
                    <p>We focus solely on high-quality <b>Engine</b> designed to maximize performance and dependability. Built to OEM standards or higher, our components ensure greater efficiency, smoother power delivery, and extended engine life. Whether you're rebuilding or upgrading, we deliver engine solutions you can trust.</p>
                </div>
                <div class="cmn-btn">
