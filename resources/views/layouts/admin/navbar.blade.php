<nav class="sidebar-nav scroll-sidebar" data-simplebar>
    <ul id="sidebarnav">
        ...
        @can('auto_enquiry-view')
            <li class="sidebar-item">
                <a class="sidebar-link @if (Route::is('admin.auto_enquiries.*')) active @endif"
                    href="{{ route('admin.auto_enquiries.index') }}" aria-expanded="false">
                    <span>
                        <i class="ti ti-bell"></i>
                    </span>
                    <span class="hide-menu">Auto Parts Enquiries</span>
                </a>
            </li>
        @endcan
